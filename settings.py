...
# DATA_TRAIN_PATH = os.path.join(DIR_PATH, 'Resource/data')
# DATA_TEST_PATH = os.path.join(DIR_PATH, 'data/10_cate/test/')
DATA_TRAIN_JSON = os.path.join(DIR_PATH, 'Resources/data/data_train.json')
DATA_TEST_JSON = os.path.join(DIR_PATH, 'Resources/data/data_test.json')
...
NEW_DATA = os.path.join(DIR_PATH,'Resources/data/timviecnhanh.json')
