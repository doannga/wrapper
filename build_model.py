...
class Classifier(object):
    ...
    def __training_result(self):
        ...
        self.plot_confusion_matrix(y_true, y_pred, title='Confusion matrix from Logistic, without normalization')
    ...
    def plot_confusion_matrix(cm,
                            normalize=False,
                            title=None):
        classes= ["title","company","time","address_work","salary","careers","benefits","descriptions","required_skills", "experience","type_employee","diploma","full_part","sex","age"]
        plt.figure()
...
if __name__ == '__main__':
    ...
    # Navie Bayet Gaussian
    # print ('Training by Navie Bayet Gaussian ...')
    # nb_gaussian = Classifier(features_train=features_train, features_test=features_test, labels_train=labels_train, labels_test=labels_test,estimator= MultinomialNB())
    # nb_gaussian.training()
    # nb_gaussian.save_model(filePath='trained_model/nb_gaussian_model.pk') # save Model
    # print ('Training by Navie Bayet Gaussian !')
